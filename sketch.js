 ...
 if(gamestate==home) {
    ...
    airgroup.destroyEach();
      ...
      if(mousePressedOver(easyb)) {
        MC='E';
        gamestate="level1";
        //cyclops.velocityX=-11;
        //cyclops.velocityY=-11;
  ...
  if(sea.x<0){
   ...
   if(keyDown("up")) {
    ...
    if(Time > 2800){
     ...
     // fishmonstergroup.destroyEach();
      //poisongroup.destroyEach();
      //fishmonstergroup.visible=false;
      //poisongroup.visible=false;
      //poisongroup.setXEach=6666;
      //fishmonstergroup.setXEach=6666;
      //sea.velocityX=0;
    }
